...
namespace Pmfst_GameSDK
{
    ...
    public class Udica : Sprite
    {
        public Udica(string path,int xor,int yor)
            :base(path,xor,yor)
        {
        }
    ...
    abstract public class MorskaCuda : Sprite
    {
        public MorskaCuda(string path, int xor, int yor)
            :base(path,xor,yor)
        {
        }
    ...
    public class RibaMala : MorskaCuda
    {
        public RibaMala(string path, int xor, int yor)
            :base(path,xor,yor)
        {
            Bodovi = 200;
            Speed = 7;
    ...
    public class RibaSrednja : MorskaCuda
    {
        public RibaSrednja(string path, int xor, int yor)
            : base(path, xor, yor)
        {
            Bodovi = 100;
            Speed = 6;
    ...
    public class RibaVelika : MorskaCuda
    {
        public RibaVelika(string path, int xor, int yor)
            : base(path, xor, yor)
        {
            Bodovi = 50;
            Speed = 5;
    ...
    public class Rak : MorskaCuda
    {
        public Rak(string path, int xor, int yor)
            : base(path, xor, yor)
        {
            Bodovi = 320;
            Speed = 4;
    ...
    public class Meduza : MorskaCuda
    {
        public Meduza(string path, int xor, int yor)
            : base(path, xor, yor)
        {
            Bodovi = -250;
        }
